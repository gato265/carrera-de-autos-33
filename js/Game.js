...
if ((players[0].rank === 0 && players[1].rank === 0)||players[0].rank===1) {
  ...
  //Semsp; es una etiqueta que se utiliza para mostrar cuatro espacios 
leader1= players[0].rank +"Semsp;" +players[0].name +"Semsp;" + players[0].score;

leader2= players[1].rank +"Semsp;" +players[1].name +"Semsp;" + players[1].score;

}
if (players[1].rank ===1) {
  leader1= players[1].rank +"Semsp;" +players[1].name +"Semsp;" + players[1].score;

  leader2= players[0].rank +"Semsp;" +players[0].name +"Semsp;" + players[0].score;
}
